...
public class MainPOS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableSales.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "kode produk", "nama produk", "harga", "Qty.", "jumlah harga", "Diskon"
            }
        ) {
        ...
        tableCatalog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Produk", "Deskripsi", "Kategori", "Harga Jual", "Pajak", "Harga Beli", "Qty", "Status", "Kode"
            }
        ) {
            Class[] types = new Class [] {
        ...
        addButtonCatalog.setText("tambah");
        ...
        deleteButtonCatalog.setText("hapus");
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(deleteButtonCatalog, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
        ...
        labelCategoryList.setText("KATEGORI");

        labelCategoryName.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
        labelCategoryName.setText("nama kategori");
        ...
        deleteButtonUser.setText("hapus");
        ...
        printSR.setText("Print Laporan Penjualan");
        ...
        printIndPS.setText("Print Laporan Penjualan Per Produk");
    ...
    private void printSRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printSRActionPerformed
        ...
        try{
            ...
            txtReport.setText("ID Penjualan\t\tWaktu\t\t\tTotal\t\tDIbayar\t\tKembalian\t\tUser\n\n");
    ...
    private void printIndPSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printIndPSActionPerformed
        // TODO add your handling code here:
          try{
            ...
            rsmd = rs.getMetaData();
            int columnCount = rsmd.getColumnCount();
            txtReport.setText("#\t\tID Penjualan\t\tKode\t\tHarga\t\tTotal\t\tQty\t\tDiskon\n\n");
